...
$PYTHON -m pip install "google-tunix[prod]" --upgrade

# 验证安装
echo "Verifying installation..."
$PYTHON -c "import tunix; print(f'Tunix installed successfully')" || {
...
echo ""
echo "Next steps:"
echo "1. Run training script: $PYTHON scripts/train_qwen3_gsm8k.sh"
