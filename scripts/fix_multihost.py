...
def main():
    ...
    # Replace with process_allgather for multi-host support
    old_line1 = 'out_tokens, lengths = jax.device_get(out_tokens), jax.device_get(lengths)'
    new_line1 = '''# Multi-host fix: use process_allgather instead of device_get
    ...
    # This one is trickier - we need to gather first, then slice
